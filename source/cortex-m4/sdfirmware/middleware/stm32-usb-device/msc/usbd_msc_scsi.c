                           ...
                           uint8_t *params)
{
  ...
  case SCSI_TEST_UNIT_READY:
    ret = SCSI_TestUnitReady(pdev, lun, params);
    break;
    
  case SCSI_REQUEST_SENSE:
    ret = SCSI_RequestSense (pdev, lun, params);
    break;

  case SCSI_INQUIRY:
    ret = SCSI_Inquiry(pdev, lun, params);
    break;
    
  case SCSI_START_STOP_UNIT:
    ret = SCSI_StartStopUnit(pdev, lun, params);
    break;
  ...
  case SCSI_MODE_SENSE6:
    ret = SCSI_ModeSense6 (pdev, lun, params);
    break;
    
  case SCSI_MODE_SENSE10:
    ret = SCSI_ModeSense10 (pdev, lun, params);
    break;
    
  case SCSI_READ_FORMAT_CAPACITIES:
    ret = SCSI_ReadFormatCapacity(pdev, lun, params);
    break;
    
  case SCSI_READ_CAPACITY10:
    ret = SCSI_ReadCapacity10(pdev, lun, params);
    break;
    
  case SCSI_READ10:
    ret = SCSI_Read10(pdev, lun, params);
    break;
    
  case SCSI_WRITE10:
    ret = SCSI_Write10(pdev, lun, params);
    break;
    
  case SCSI_VERIFY10:
    ret = SCSI_Verify10(pdev, lun, params);
    break;
