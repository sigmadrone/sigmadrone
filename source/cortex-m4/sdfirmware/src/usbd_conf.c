...
void HAL_PCD_MspInit(PCD_HandleTypeDef *hpcd)
{
  ...
  if(hpcd->Instance == USB_OTG_FS)
  {
    ...
    GPIO_InitStruct.Pin = (1<<STM_PIN(USBOTG_FS1_DM_PIN)) | (1<<STM_PIN(USBOTG_FS1_DP_PIN));
	...
	/* Configure VBUS Pin */
    GPIO_InitStruct.Pin = 1<<STM_PIN(USBOTG_VBUS_FS1_PIN);
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
    
    /* Configure ID pin */
    GPIO_InitStruct.Pin = 1<<STM_PIN(USBOTG_FS1_ID_PIN);
