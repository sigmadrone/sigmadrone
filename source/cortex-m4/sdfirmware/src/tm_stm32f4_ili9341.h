...
#define ILI9341_RST_PIN				GPIO_PIN_13
#endif
 ...
 * @retval None
 */
void TM_ILI9341_Puts(uint16_t x, uint16_t y, const char*, TM_FontDef_t *font, uint32_t foreground, uint32_t background);
 ...
 * @retval None
 */
void TM_ILI9341_GetStringSize(const char*, TM_FontDef_t* font, uint16_t* width, uint16_t* height);
