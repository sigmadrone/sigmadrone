...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define USBD_VID                      0x781  //0x0483 - we need our own vendor/product IDs
#define USBD_PID                      0x5153 //0x5720
#define USBD_LANGID_STRING            0x409
//#define USBD_MANUFACTURER_STRING      "STMicroelectronics"
#define USBD_MANUFACTURER_STRING      "SigmaDrone"
//#define USBD_PRODUCT_HS_STRING        "Mass Storage in HS Mode"
#define USBD_PRODUCT_HS_STRING        "Firmware Drive"
